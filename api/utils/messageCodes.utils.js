    ...
    const codeArr = [
        {
            ...
            body: `Hi ${data.username}, you have registered to Pasion Argenta, if this was not you, please click on the following link... yeah, I know, there's no link, I mean, this site is fake, what did you expect?`,
        },
        {
            code: 'orderCreated',
