    ...
    return (
        <>
            ...
            <Box sx={{ ml: 5, position: 'relative', display: 'inline-flex' }}>
                <CircularProgress variant="determinate" value="100" color="secondary" size={150} />
                <Box
                    sx={{
                        top: 0,
                        left: 0,
            ...
            <Typography sx={{ ml: 4, fontStyle: 'italic' }}>Basado en {product.length} opiniones</Typography>
        </>
    )
}
