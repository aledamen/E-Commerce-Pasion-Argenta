...
export const ProductDetails = () => {
    ...
    return (
        <>
            ...
            <Snackbar open={openFavorites} autoHideDuration={3000} onClose={handleClose}>
                <Alert severity="success">Product added to Favorites</Alert>
            </Snackbar>
            <Snackbar open={openRemoveFavorites} autoHideDuration={3000} onClose={handleClose}>
                <Alert severity="success">Product removed from Favorites</Alert>
            </Snackbar>
            {product[0] ? (
                <Container>
                    <p>
                        <Reviews product={product[0].review} />
                    </p>
                </Container>
            ) : (
                <div></div>
